...
export const RETRIEVE_REFERENCE_START = "RETRIEVE_REFERENCE_START";
...
export const RETRIEVE_AUTH_START = "RETRIEVE_AUTH_START";
export const RETRIEVE_AUTH_SUCCESS = "RETRIEVE_AUTH_SUCCESS";
export const RETRIEVE_AUTH_FAILURE = "RETRIEVE_AUTH_FAILURE";

export const SUBSCRIBE_NEWSLETTER_BUSINESS_START = "SUBSCRIBE_NEWSLETTER_BUSINESS_START";
export const SUBSCRIBE_NEWSLETTER_BUSINESS_SUCCESS = "SUBSCRIBE_NEWSLETTER_BUSINESS_SUCCESS";
export const SUBSCRIBE_NEWSLETTER_BUSINESS_FAILURE = "SUBSCRIBE_NEWSLETTER_BUSINESS_FAILURE";
